...
function createData(text, itemcode, createDate, updateDate, store) {
  return { text, itemcode, createDate, updateDate, store };
}

const rows = [
  createData('FS - Do Uong', '004', '2019-04-09 08:44:00', '2019-11-01 14:10:00', '1'),
...
export default function MkeymapServer() {
